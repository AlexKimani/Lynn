 ...
 */
public class SchoolView extends FrameView {

    public SchoolView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = SchoolApp.getApplication().getMainFrame();
            aboutBox = new SchoolAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        SchoolApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(school.SchoolApp.class).getContext().getResourceMap(SchoolView.class);
        ...
        jInternalFrame1.setBounds(80, 80, 340, 170);
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jDesktopPane1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 445, Short.MAX_VALUE)))
        );
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(school.SchoolApp.class).getContext().getActionMap(SchoolView.class, this);
        ...
        statusPanel.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
